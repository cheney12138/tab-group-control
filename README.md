...
- **终端蓝(Terminal)**:雾蓝紫底 + 藏青墨,全局等宽字体、直角部件、实线分隔,零光晕的 TUI 语言
- **千禧复古(Y2K)**:千禧年前后中文 BBS 论坛 —— 通篇中性冷灰打底,只留一条钢蓝横幅和几个小色点;1px 细外框 + 细织布纹底,层级靠 1px 线划分而不靠明暗,零投影;灰面斜面按钮、直角勾选框、经典方轨滚动条;固定亮色
- 四套主题共用同一套 token 体系,互不影响;突出色蓝/青/绿/橙/玫红五色可换,各主题有各自的适配值。新增主题的强制义务与主题资产白名单见 `docs/theming.md`
